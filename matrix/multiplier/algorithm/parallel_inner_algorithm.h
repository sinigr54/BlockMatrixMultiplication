...
#ifndef MATRIXMUL_PARALLEL_MULTIPLIER_H
#define MATRIXMUL_PARALLEL_MULTIPLIER_H
...
template <class T>
class parallel_inner_algorithm {
...
template<class T>
matrix<T> parallel_inner_algorithm<T>::execute(const block_matrix<T> &m1, const block_matrix<T> &m2) {
...
template<class T>
void parallel_inner_algorithm<T>::block_multiply(const block_matrix<T> &m1,
                                                 const block_matrix<T> &m2,
                                                 matrix<T> &result_matrix,
                                                 int i,
                                                 int j,
...
#endif //MATRIXMUL_PARALLEL_MULTIPLIER_H
